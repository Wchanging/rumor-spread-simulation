...
def main() -> None:
    parser = argparse.ArgumentParser(description="RQ1 background competition analysis (isolated/moderate/high)")
    parser.add_argument(
        "--aggregates",
        type=str,
        default="output/paper_tables/experiment_aggregates.csv",
        help="Aggregated CSV generated by build_paper_tables.py",
    )
    parser.add_argument(
        "--dest",
        type=str,
